...
{
    [self addTapGestureRecognizerBlock:gestureBlock shouldBeginBlock:nil];
}

-(void)addDoubleTapGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock
{
    [self addDoubleTapGestureRecognizerBlock:gestureBlock shouldBeginBlock:nil];
}

-(void)addPanGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock
{
    [self addPanGestureRecognizerBlock:gestureBlock shouldBeginBlock:nil];
}

-(void)addLongPressGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock
{
    [self addLongPressGestureRecognizerBlock:gestureBlock shouldBeginBlock:nil];
}
...
-(void)addLongPressGestureRecognizerBlockOnlyEnd:(YZHGestureRecognizerBlock)gestureBlock
{
    ...
    [self addLongPressGestureRecognizerBlock:gestureBlock shouldBeginBlock:nil actionOptionsInfo:actionOptionsInfo];
}
...
{
    [self addPanGestureRecognizerBlock:gestureBlock shouldBeginBlock:shouldBeginBlock actionOptionsInfo:nil];
}
...
-(void)addLongPressGestureRecognizerBlock:(YZHGestureRecognizerBlock)gestureBlock shouldBeginBlock:(YZHGestureRecognizerShouldBeginBlock)shouldBeginBlock
{
    ...
    [self addLongPressGestureRecognizerBlock:gestureBlock shouldBeginBlock:shouldBeginBlock actionOptionsInfo:actionOptionsInfo];
}
...
{
    [self addPanGestureRecognizerBlock:gestureBlock shouldBeginBlock:nil actionOptionsInfo:optionsInfo];
}
...
{
    [self addLongPressGestureRecognizerBlock:gestureBlock shouldBeginBlock:nil actionOptionsInfo:optionsInfo];
}
