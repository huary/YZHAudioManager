...
-(AVAudioRecorder*)audioRecorder
{
    if (_audioRecorder == nil) {
        ...
        self.timer = [NSTimer scheduledTimerWithTimeInterval:0.1 target:[NSWeakProxy proxyWithTarget:self] selector:@selector(_updateMetersAction:) userInfo:nil repeats:YES];
    }
